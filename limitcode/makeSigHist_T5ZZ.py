...
folder_prefix = "significance_T5ZZ_070317_paralleltest"
f_rvalues = r.TFile(os.path.join(folder_prefix,"significances_T5ZZ.root"),"READ")
...
mGLow = massplane_obs.GetXaxis().FindBin(900)
mGHigh = massplane_obs.GetXaxis().FindBin(2400)
mLSPLow = massplane_obs.GetYaxis().FindBin(100)
mLSPHigh = massplane_obs.GetYaxis().FindBin(2400)
vmG = []
vmLSP = []
vxsec = []
vobs = []
...
#hlim.GetZaxis().SetRangeUser(-3,3)
...
c_massplane.SaveAs("/home/users/bsathian/public_html/T5ZZ_Significance_13TeV.pdf")
